...
const StyledTableRow = styled(TableRow)(({ theme }) => ({
  "&:nth-of-type(odd)": {
    backgroundColor: "var(--tertiaryColour)",
  },
  "&:nth-of-type(even)": {
    backgroundColor: "var(--quadraColour)",
  },
  // hide last border
...
const ArchitecturePageData = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await deleteDoc(doc(db, "ArchitectureProject", id));
      fetchData();
    } catch (error) {
              ...
              <>
                <StyledTableRow key={item.id}>
                  ...
                  <StyledTableCell align="right">
                    <ArchitectureMangForm data={item} id={item.id}>
...
export default ArchitecturePageData;
